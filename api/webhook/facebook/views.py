...
class FacebookWebhookAPIView(APIView):
    ...
    def process_customer_message(self, company, messaging):
        ...
        if message is None:
            ...
            # Process automation
            if 'details' in message_details.data.message.lower() or "interested" in message_details.data.message.lower() or "get started" in message_details.data.message.lower():
