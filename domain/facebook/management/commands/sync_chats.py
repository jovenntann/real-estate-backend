...
class Command(BaseCommand):
    ...
    def sync_chats(self):
        ...
        self.process_conversations(page=page, company=company)

    def process_conversations(self, page: Page, company: Company):
    ...
    def get_or_create_lead(self, page: Lead, company: Company, user_id: int):
